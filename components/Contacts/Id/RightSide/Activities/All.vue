<script lang="ts" setup>
  ...
  const { getActivityByContact, delayedActivities, pinnedActivities, pendingActivities, completedActivities } =
    useActivity()
...
<template>
  <div v-auto-animate class="p-2 text-slate-500">
    <div v-if="pinnedActivities?.length > 0" class="activities">
    ...
    <div v-if="delayedActivities?.length > 0" class="activities">
    ...
    <div v-if="pendingActivities?.length > 0" class="activities">
    ...
    <div v-if="completedActivities?.length > 0" class="activities">
