  ...
  <div class="mt-2 h-20 border border-slate-200 rounded flex items-center justify-between">
    ...
    <div>
      <div class="ml-4 text-cyan-600 font-semibold flex text-xl items-center">
        ...
        <div class="h-6 ml-4 bg-green-500 px-2 leading-6 rounded-sm text-white text-[10px] uppercase">
    ...
    <div class="mr-4">
      <div class="flex">
        ...
        <button class="relative">
          ...
          <div class="h-auto w-64 border absolute shadow top-full right-0 bg-white mt-4 py-2 px-3" v-if="show">
        ...
        <button class="ml-2 h-6 w-6 border rounded border-slate-300 text-slate-400 hover:bg-slate-100">
...
const { contact, updateContact } = useContacts();
