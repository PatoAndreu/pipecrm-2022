...
export const useContacts = () => {
  ...
  const { filteredContacts, contact, contacts, errorMessages, showDrawer, tabSelected } = storeToRefs(contactsStore)
  ...
  return {
    filteredContacts, contact, contacts, errorMessages, showDrawer, tabSelected,
